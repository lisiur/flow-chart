System.register(["./Arc", "./Polygon", "./Polyline", "./Vec2"], function (exports_1, context_1) {
    "use strict";
    var Arc_1, Polygon_1, Polyline_1, Vec2_1, Arrow;
    ...
    return {
        ...
        execute: function () {
            Arrow = /** @class */ (function () {
                ...
                Arrow.prototype.render = function (config) {
                    ...
                    // draw line
                    var startWrapPoint = start.add(new Vec2_1.default(0, wrapLength));
                    var endWrapPoint = end.add(new Vec2_1.default(0, -(end.y - start.y - wrapLength)));
